...
if __name__ == "__main__":
    ...
    # Get feature names after one-hot encoding for better understanding of input_shape
    # This is a bit manual but good for debugging
    ...
    # Predictions
    y_pred_proba = model.predict(X_test_processed).ravel() # Get probabilities
    y_pred_classes = (y_pred_proba > 0.5).astype(int)    # Convert probabilities to class labels (0 or 1)
